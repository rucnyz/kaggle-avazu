...
param = {'max_depth': 15, 'eta': .02, 'objective': 'binary:logistic', 'verbose': 0,
         ...
         'nthread': 16, 'colsample_bytree': .5, 'base_score': 0.16, 'seed': 999, 'eval_metric': 'logloss'}
...
ctr = 0
for idx in [0, 1, 2, 3]:
	filter1 = np.logical_and(np.logical_and(day_values >= 22, day_values < day_test),
	...
	xgb1 = xgb.train(param, dtrain, n_trees, watchlist)
